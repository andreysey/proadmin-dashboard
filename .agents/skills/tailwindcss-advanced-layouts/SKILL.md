...
```html
<!-- Sticky header -->
<header class="sticky top-0 z-50 border-b bg-white/80 backdrop-blur-sm">Navigation</header>
...
<!-- Fixed action button -->
<button class="bg-brand-500 fixed right-6 bottom-6 z-40 rounded-full p-4 shadow-lg">
  <PlusIcon />
</button>
```
...
<div class="ms-auto ps-4 pe-6">Padding and margin that respect text direction</div>
...
<div class="@container">
  <div
    class="/* Container query for component-level responsiveness */ /* Media query for page-level responsiveness */ lg:grid lg:grid-cols-2 @md:flex @md:gap-4"
  >
    Content
  </div>
</div>
